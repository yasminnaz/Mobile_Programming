...
class _GeolocationScreenState extends State<GeolocationScreen> {
  ...
  Future<void> _pickLocationFromMap() async {
      ...
      MaterialPageRoute(
        builder: (context) => Scaffold(
          ...
          body: FlutterLocationPicker(
            ...
            mapLanguage: 'id',
            userAgent: 'lokasiflutter/1.0 (contact@email.com)',
    ...
    if (result != null) {
      setState(() {
        _kecamatan = result.addressData?['suburb'] ?? "Tidak diketahui";
        _kota =
            result.addressData?['city'] ??
            result.addressData?['town'] ??
            result.addressData?['village'] ??
            "Tidak diketahui";
      });
    }
  }
